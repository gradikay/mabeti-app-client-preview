                ...
                <section className="col-md-5 mx-auto">
                    ...
                    <footer className="p-2  w-100 border-top">
                        <p className="border-bottom pb-3">
                            <mdall>By registering, you agree to Mabeti's <a href="#">Terms of Service</a> and <a href="#">Privacy Notice</a>.</mdall>
                        </p>
            ...
            <div className="row">
                ...
                <section className="col-md-5 mx-auto">
                    ...
                    <section className="p-2 border-top">
                        <p className="border-bottom pb-3">
                            <small>By using this application, you agree to Mabeti's <a href="#">Terms of Service</a> and <a href="#">Privacy Notice</a>. </small>
                        </p>
